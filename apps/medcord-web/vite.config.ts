...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      // Specific alias first so '@medcord/ui/styles.css' wins before the bare '@medcord/ui' rule.
      {
        find: '@medcord/ui/styles.css',
        replacement: path.resolve(__dirname, '../../packages/ui/src/styles.css'),
      },
      { find: /^@medcord\/ui$/, replacement: path.resolve(__dirname, '../../packages/ui/src/index.ts') },
      {
        find: /^@medcord\/core$/,
