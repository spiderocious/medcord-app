...
export function AdminLoginForm({ onSubmit, isLoading, error }: AdminLoginFormProps) {
  ...
  return (
    <div className="space-y-1 mb-5">
      <AppText variant="caption" className="text-charcoal-700">
        ...
        <div>
          ...
          <div className="relative mt-1">
            <input
              ...
              disabled={isLoading}
              className="block w-full rounded-lg border border-forest-900/20 bg-white px-3 py-2 pr-10 text-sm text-charcoal-900 placeholder-charcoal-700/50 focus:border-forest-900 focus:outline-none focus:ring-1 focus:ring-forest-900 disabled:opacity-50 disabled:cursor-not-allowed"
              placeholder="••••••••"
            />
            <button
              type="button"
